                           ...
                           <tr>
                            ...
                            <td class="px-4 py-2">
                                <a href="{{route('categories.edit', ['categoryId' => $category->category_id])}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20" onclick="window.location.href='{{ route('categories.edit', ['categoryId' => $category->category_id]) }}';" style="cursor: pointer;" fill="blue" class="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
