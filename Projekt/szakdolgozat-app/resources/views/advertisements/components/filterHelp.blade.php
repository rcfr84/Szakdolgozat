        ...
        <form action="{{ route('advertisements.filter') }}" method="GET" class="mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center mb-4">
                <div class="mb-4">
                    ...
                    <select class="form-select border-gray-300 focus:border-sky-500 focus:ring-sky-500 rounded-md shadow-sm" name="county_id" id="countySelect">
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select border-gray-300 focus:border-sky-500 focus:ring-sky-500 rounded-md shadow-sm" name="city_id" id="citySelect">
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select border-gray-300 focus:border-sky-500 focus:ring-sky-500 rounded-md shadow-sm" name="category_id" id="category">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center mb-4">
                <div class="mb-4">
                    ...
                    <input type="number" name="min_price" placeholder="Ft" class="form-input border-gray-300 focus:border-sky-500 focus:ring-sky-500 rounded-md shadow-sm mb-4">
                </div>
                <div class="mb-4">
                    <label for="max_price" class="block text-sm font-medium text-gray-700">Maximum ár:</label>
                    <input type="number" name="max_price" placeholder="Ft" class="form-input border-gray-300 focus:border-sky-500 focus:ring-sky-500 rounded-md shadow-sm mb-4">
                </div>
                <div class="mb-4">
                    <label for="sort" class="block text-sm font-medium text-gray-700">Rendezés:</label>
                    <select class="form-select border-gray-300 focus:border-sky-500 focus:ring-sky-500 rounded-md shadow-sm" name="sort_by" id="sort_by">
