...
\begin{document}
	...
	\addcontentsline{toc}{chapter}{Függelékek}
		\section*{Követelménylista}
			...
			\end{longtable}
			\section*{Blade}
				\lstinputlisting[caption={Egy hirdetés megjelenítésére szolgáló felület}, label=kod-blade, style=php]{./fejlesztoi/hirdetesBlade.blade.php}
