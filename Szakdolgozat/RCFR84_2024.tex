...
\begin{document}
	...
	\subsection{Migráció}
		...
		\lstinputlisting[caption={Egy migrációra példa kód}, label=kod-migracio, style=php]{./fejlesztoi/hirdetes.php}
	...
	\subsection{Modell}
		...
		\lstinputlisting[caption={Egy modellre példa kód részlet}, label=kod-modell, style=php]{./fejlesztoi/hirdetesModell.php}
	...
	\subsection{Kontroller}\label{sc-kontroller}
		...
		\lstinputlisting[caption={Egy kontrollerben lévő metódus}, label=kod-kontoller, style=php]{./fejlesztoi/hirdetesShow.php}
	...
	\subsection{Web.php}
		...
		\lstinputlisting[caption={Egy web.php lévő útvonal}, label=kod-utvonal, style=php]{./fejlesztoi/hirdetesUtvonal.php}
