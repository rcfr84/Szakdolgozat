...
\begin{document}
	...
	\chapter{Üzleti modell}
		Az én meglátásom szerint az apróhirdetés weboldalak fenntartásához, működéséhez és karbantartásához szükség van némi anyagi forrásra. A következőben szeretném Önnek bemutatni, hogy milyen megoldások segítségével tudnám én ezt elképzelni. Azt kiemelném, hogy ha a következő javaslatok közül némelyik opció implementálására az adatbázis alapú webalkalmazásom jelenlegi formájában még nem lenne alkalmas rá.
		 \section{Online hirdetések}
